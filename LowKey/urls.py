...
urlpatterns = [
    ...
    path('shops/<int:shop_id>/product/', views.ShopProductList.as_view(), name='product-list'),
    ...
    path('searchshops/', views.SearchShopView.as_view()),
    path('searchproducts/', views.SearchProductView.as_view()),
